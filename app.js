  ...
  ic().innerHTML = `
    <div class="ia-sayfa">
      <div class="ia-ust">
        ...
        <button type="button" class="ia-arsiv-btn ${iaArsivAcik ? 'sec' : ''}" id="iaArsivBtn" title="Arşiv (içe aktarılanlar)">${ik('belge')}<span>${iaArsivAcik ? 'Arşivi Kapat' : 'Arşiv'}</span></button>
      </div>
      <div id="iaGovde"></div>
    </div>`;
